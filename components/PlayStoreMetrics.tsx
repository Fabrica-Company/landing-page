...
export const PlayStoreMetrics: React.FC<PlayStoreMetricsProps> = ({
  ...
  if (variant === 'featured') {
    return (
      ...
      >
        <div className="min-w-[140px] px-6 py-4 rounded-xl bg-accent-blue/10 dark:bg-accent-blue/15 border border-accent-blue/30 shadow-sm">
          <div className="flex items-center justify-center gap-2 text-accent-blue mb-1">
        ...
        <div className="min-w-[140px] px-6 py-4 rounded-xl bg-accent-blue/10 dark:bg-accent-blue/15 border border-accent-blue/30 shadow-sm">
          ...
          <p className="text-3xl font-bold text-text-primary dark:text-dark-text-primary text-center">
            {rating}
            <span className="text-lg text-accent-blue ml-0.5">★</span>
          </p>
          <p className="text-xs text-text-secondary dark:text-dark-text-secondary text-center mt-0.5">
            Average rating
          </p>
  ...
  return (
    <div
      ...
      aria-label={`Play Store: ${downloads} downloads, ${rating} star rating`}
    >
      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-accent-blue/15 text-accent-blue border border-accent-blue/30">
